            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered table-striped" id="employees_table" style="margin-top: 0px!important;">
                  <thead>
                    <tr>
                      <th class="text-center">NAME OF ATHLETE</br>(LAST NAME, FIRST NAME, M.I.)</th>
                      <th class="text-center">AGE</th>
                      <th class="text-center">ADDRESS</th>
                      <th class="text-center">YEARS OF RESIDENCY</th>
                      <th class="text-center">DATE OF BIRTH</th>
                      <th class="text-center">
                        Check the checkbox if the</br>player is eligible for SCUAA.
                        <br>
                        <center>
                  ...
                  <tbody class="text-center">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?= $age?></td>
                        <td><?= $value->address?></td>
                        <td><?= (date('Y') - $value->year_enrolled); ?></td>
