                    ...
                    <div class="form-group">
                      <label>Birthdate:</label>
                        <div class="input-group date">
                            <input type="date" class="form-control" placeholder="Enter/Select Birthdate" name="datebirth" />
                            <div class="input-group-append">
